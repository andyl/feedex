defmodule RaggedData.Util.UtilMapTest do
  use ExUnit.Case, async: true
  doctest RaggedData.Util.UtilMap

  alias RaggedData.Util.UtilMap
  import UtilMap

  describe "a flat map" do
  ...
  describe "a flat map with sub-map" do
  ...
  describe "a two-level nested map" do
  ...
  describe "a nested list of maps" do
