...
- [x] Get running on new devhost 

## 2023 Feb 20 Mon 

- [x] Remove test warnings 

## 2023 Feb 21 Tue

- [x] Cleanup Api.Folder and Ctx.Folder 
- [x] Make tests for new functions 
- [x] Get form working 
- [x] Tests for folder changeset (validation)
- [x] Tests for folder changset (save)
- [x] Tests for folder delete
- [x] Finish Edit folder 

## 2023 Feb 23 Thu

- [x] Cleanup `body_add_feed_component`
- [x] Specify API for Api.RegFeed 
- [x] Cleanup Api.RegFeed and Ctx.RegFeed 
- [x] Tests for Api.RegFeed and Ctx.RegFeed 
- [x] Finish Edit feed 

Api.RegFeed 
- RegFeed.create_or_find_regfeed(

## 2023 Mar 02 Thu

Recap 
- LiveView: forms (.simple_form) 
- LiveComponents and FunctionComponents 
- Ecto / Changesets 
...
- [x] Finish layout 
- [x] Working add/edit forms 
- [x] Working feed input form 

## 2023 Mar 04 Sat

Conversion 
- [x] make an archive directory 
- [x] move old stuff to archive 
- [x] move new stuff to repo - leave it as 
- [x] get new stuff working fully 

Basics 
- [x] Generate docs 
- [x] Run FeedexJob in background 
- [x] Get FeedList Import/Export working 
- [x] Run end-to-end
- [x] Configure PushState
- [x] Finish PushState 
...
Testing Ecto/Changesets 
- [x] Read Ecto Book (testing) 
- [x] Add changeset tests 

Testing 
- [x] Write liveview tests 
- [x] Write changeset tests 
- [x] Refactor libraries 

Fixes 
- [x] Fix ALL link 
- [x] Fix delete feed 
- [x] Get rid of Distillery 
- [x] Get rid of Timex 
- [x] Drop ExMachina 
- [x] Modex: Source from GitHub 
- [x] Pets:  Source from GitHub 

## 2023 Mar 09 Thu

Learnings: 
- Neovim: ChatGPT, Emmet LS, Tailwind LS 
- Pragmatic Programmer: Forms 

## 2023 Mar 11 Sat

Fixes: Near Term 
- [x] Clicking ALL does not refresh the body posts list 
- [x] Remove "mode=view" from url params 
- [x] Remove inspect statements

## 2023 Mar 12 Sun

Formatting 
- [x] Add tailwind LS to neovim 
- [x] Reread the Tailwind book 
- [x] Fix page layout 
- [x] Checkout Flowbite and DaisyUI 
- [x] Study Dart-Sass (Prag Studio Blog Post) 
