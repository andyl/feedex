...
config :feedex, FeedexWeb.Endpoint,
  ...
  url: [host: "localhost"],
  render_errors: [
    formats: [html: FeedexWeb.ErrorHTML, json: FeedexWeb.ErrorJSON],
    layout: false
  ],
...
config :feedex, Feedex.Mailer, adapter: Swoosh.Adapters.Local

# ----- FeedexJob

config :feedex, FeedexJob.Scheduler,
  env: Mix.env(),
  jobs: [
...
config :git_ops,
  ...
  repository_url: "https://github.com/andyl/feedex",
  types: [
