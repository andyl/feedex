defmodule FeedexWeb.Telemetry do
  use Supervisor
  ...
  def init(_arg) do
    children = [
      ...
      {:telemetry_poller, measurements: periodic_measurements(), period: 20_000},
      # Add reporters as children of your supervision tree.
      # {Telemetry.Metrics.ConsoleReporter, metrics: metrics()}
      # {FeedexWeb.Metrics.TestReporter, metrics: metrics()}
      {FeedexWeb.Metrics.InfluxReporter, metrics: metrics()}
    ]
