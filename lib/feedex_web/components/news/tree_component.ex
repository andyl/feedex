defmodule FeedexWeb.TreeComponent do
  @moduledoc """
  Renders the tree
  ...
  defp get_fld(treemap, regid) do
    case regid do
      nil -> nil
      id when is_number(id) -> Feedex.Util.Treemap.register_parent_id(treemap, id)
      _ -> nil
    end
  end
  ...
  def handle_event("mark-read", _click, socket) do
    ...
    treemap = Feedex.Api.SubTree.cleantree(socket.assigns.uistate.usr_id)
